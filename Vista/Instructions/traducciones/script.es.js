const data_es = {
    questions: [
        {
            "question": "¡Bienvenido al ISTQB Quiz! Antes de comenzar, aquí tienes algunas instrucciones para aprovechar al máximo esta experiencia de aprendizaje:",
            instructions: [
                ...
                "El Quiz cuenta con un modo de voz opcional para mejorar la accesibilidad. Puedes activarlo o desactivarlo según tus preferencias.",
                "El tiempo empieza a transcurrir una vez pulses el botón 'Siguiente' para avanzar a la primera pregunta. ¡Buena suerte!"
            ]
        }]};
