const data_es = {
    ...
    {
        question: "¿Cuál de las siguientes afirmaciones es verdadera sobre el juego en línea y móvil?a) Los juegos que se pueden jugar a través de canales inalámbricos en el lugar y de televisión interactiva.b) Los progresivos son legales en todas las jurisdicciones cuando se juegan en línea usando su computadora.c)El juego móvil en el lugar significa que un jugador puede financiar un EGM con sus dispositivos móviles.d) Un jugador en línea puede financiar su cuenta usando una billetera digital. e) Los sitios de apuestas en línea pueden bloquear el acceso de personas que usan servidores proxy para evadir las restricciones basadas en la ubicación.",
        urlImage: "",
        options: [
            "a, b y d",
            "b, c y d",
